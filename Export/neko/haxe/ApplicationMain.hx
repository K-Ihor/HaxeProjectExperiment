...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("MyHaxeProject3", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("MyHaxeProject3", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "MyHaxeProject3";
		app.meta["name"] = "MyHaxeProject3";
		app.meta["packageName"] = "com.sample.myhaxeproject3";
